...
class TestGetProduct : KoinFreeSpec() {
    ...
    init {
        ...
        "when id matches a product id use case must return product" {
            ...
            runBlocking { product("1") } shouldBeRight mockProduct
        }
    }
}
